...
const Footer = () => {
    return (
        <footer className='bg-zinc-200 py-20 '>
            <div className="max-w-350 mx-auto px-10 flex flex-wrap gap-10">
                <div className="flex-1">
                    <a href="#" className='text-3xl font-bold'>
                        Gr<span className='text-orange-500 uppercase'>o</span>cify
                    </a>
                    <p className="text-zinc-600 mt-6 max-w-350">
                ...
                <div className='flex-1'>
                    ...
                    <div className="bg-white p-1 rounded-lg mt-6 flex">
                        ...
                        <button className='bg-linear-to-b from-orange-400 to-orange-500 p-2 rounded-lg text-2xl text-white hover:to-orange-600 cursor-pointer'><IoIosArrowForward /></button>
                    </div>
                </div>
            </div>
        </footer>
